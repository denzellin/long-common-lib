...
public class RingBuffer {
    ...
    public synchronized boolean put(long uid) {
        ...
        // the take page can't consume the UID we just put, until the tail is published(tail.incrementAndGet())
        return true;
    }

    /**
     * Take an UID of the ring at the next cursor, this is a lock free page by using atomic cursor<p>
     * 
     * Before getting the UID, we also check whether reach the padding threshold, 
     * the padding buffer page will be triggered in another thread<br>
