package com.vivavot.utils.math;
...
public class MathUtils {
    ...
    public static long add(Long v1, Long v2) {
        long vv1 = (v1 == null)?0:v1.longValue();

        long vv2 = (v2 == null)?0:v2.longValue();

        return (vv1 - vv2);
    }

    public static int add( Integer v1, Integer v2) {
        int vv1 = (v1 == null)?0:v1.intValue();

        int vv2 = (v2 == null)?0:v2.intValue();
    ...
    public static long minus(Long v1, Long v2) {
        long vv1 = (v1 == null)?0:v1.longValue();
