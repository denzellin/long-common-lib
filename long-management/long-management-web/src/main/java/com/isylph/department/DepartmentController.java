...
public class DepartmentController extends BaseSpringSecurityController {
    ...
    @Operation(description = "创建部门", summary = "201")
    @PostMapping(value = "")
    ...
    @Operation(description = "编辑部门", method = "", summary = "202")
    @PutMapping(value = "")
    ...
    @Operation(description = "查询机构", method = "/org", summary = "203")
    ...
    @Operation(description = "查询部门详情", method = "/**", summary = "204")
    @GetMapping(value = "/{id}")
    ...
    @Operation(description = "查询部门树", method = "/tree", summary = "205")
    ...
    @Operation(description = "查询部门列表", method = "/list", summary = "206")
    ...
    @Operation(description = "删除部门", method = "/*", summary = "207")
