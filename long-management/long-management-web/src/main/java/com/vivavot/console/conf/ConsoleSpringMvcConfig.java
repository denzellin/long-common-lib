package com.vivavot.console.conf;

import com.vivavot.basis.controller.conf.SpringMvcBaseConfig;
...
public class ConsoleSpringMvcConfig extends SpringMvcBaseConfig {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
         ...
         * com.vivavot.basis.security.BaseSecurityConfig#baseConfigure
         */
